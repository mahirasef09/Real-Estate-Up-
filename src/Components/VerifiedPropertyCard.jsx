...
const VerifiedPropertyCard = ({ property }) => {
    const { _id, image, title, location, priceRange, adderName, adderEmail, status } = property;
    return (
        <div>
            <div className="card bg-base-100 w-64 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <p className='flex items-center font-bold'>Agent: {adderName}</p>
                    <p className='flex items-center font-bold'>Email: {adderEmail}</p>
