...
const MakeAnOffer = () => {
    ...
    const { propertyId, title, location, agentName, priceRange, propertyImage } = useLoaderData();
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className='flex flex-col lg:flex-row gap-5'>
                            ...
                            <div className="form-control flex-1">
                                ...
                                <input type="text" {...register('agentName', { required: true })} defaultValue={agentName} readOnly className="input input-bordered" required />
                            </div>
                        </div>
